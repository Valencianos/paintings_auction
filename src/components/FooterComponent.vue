      ...
      <div class="footer-wrapper">
        ...
        <div class="contacts">
          ...
          <div class="contacts-block">
            ...
            <p class="contacts-text">г. Санкт-Петербург, ул. Ефимова, 3</p>
          </div>
        </div>
      </div>
    </div>
